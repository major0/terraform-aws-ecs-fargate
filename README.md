...
| <a name="input_architecture"></a> [architecture](#input\_architecture) | Select the target architecture. [X86\_64, ARM64] | `string` | `"X86_64"` | no |
...
| <a name="input_runtime"></a> [runtime](#input\_runtime) | Select the os runtime. [WINDOWS\_SERVER\_2019\_FULL, WINDOWS\_SERVER\_2019\_CORE, WINDOWS\_SERVER\_2022\_FULL, and WINDOWS\_SERVER\_2022\_CORE] | `string` | `"LINUX"` | no |
